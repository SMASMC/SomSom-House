...
class SinchundongPrediction extends StatefulWidget {
  const SinchundongPrediction({super.key});

  @override
  State<SinchundongPrediction> createState() => _SinchundongPredictionState();
}

class _SinchundongPredictionState extends State<SinchundongPrediction> {
